    ...
    <div class="row flex-fill w-100 m-0">
        ...
        <div class="col-md-6 login-left d-flex justify-content-center align-items-center">
            <div>
                ...
                <h2 class="text-blue fw-bold">Log in to continue your learning journey</h2>
                    ...
                    <div class="card-body">
                        ...
                        @if ($errors->any())
                            <div class="alert alert-danger">
                                <ul class="mb-0">
                                    @foreach ($errors->all() as $erroverr)
                                        <li>{{ $error }}</li>
                                    @endforeach
                                </ul>
                            </div>
                        ...
                        <div class="text-center mt-3 mb-2 text-muted">
                            ...
                            <a href="{{ url('instructor/register') }}" class="fw-semibold text-primary text-decoration-none">
                                Sign Up
                            </a>
                        </div>
                    </div>
