    ...
    <div class="row flex-fill w-100 m-0">
        ...
        <div class="col-md-6 login-left d-flex justify-content-center align-items-center">
            <div>
                ...
                <h2 class="text-blue fw-bold">Become a Udemy Instructor</h2>
                <p class="text-blue">Discover a supportive community of online instructors. Get instant access to all course creation resources.</p>
            </div>
        </div>
