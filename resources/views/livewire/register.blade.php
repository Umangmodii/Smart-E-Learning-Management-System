                         ...
                         <hr>
                            ...
                            <div class="row g-3 mb-3 text-center">
                                <div class="col-12 col-md-4">
                                    <a href="" class="btn btn-outline-dark w-100 d-flex align-items-center justify-content-center gap-2 social-btn" aria-label="Sign in with GitHub">
                                        <!-- GitHub SVG -->
                                ...
                                <div class="col-12 col-md-4">
                                    <a href="" class="btn btn-outline-danger w-100 d-flex align-items-center justify-content-center gap-2 social-btn" aria-label="Sign in with Google">
                                        <!-- Google SVG -->
                                ...
                                <div class="col-12 col-md-4">
                                    <a href="" class="btn btn-outline-primary w-100 d-flex align-items-center justify-content-center gap-2 social-btn" aria-label="Sign in with Facebook">
                                        <!-- Facebook SVG -->
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
